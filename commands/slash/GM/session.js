            ...
            .then(async (dmr) => {
                ...
                if (!member.roles.cache.has(dmr)) {
                    ...
                    switch (option.getSubcommand()) {
                        case "select":
                            client.database.getSession(server, user)
                                .then(async (sessions) => {
                                    const rows = [];
                                    if (sessions.length <= 24) {
                                        ...
                                        collector2.on("collect", async (i) => {
                                            if (i.customId.includes("selses")) {
                                                ...
                                                client.database.updateUser(user.id, server, {
                                                    name: "session_id",
                                                            ...
                                                            await mes2.edit({
                                                                embeds: [
                                                                    new EmbedBuilder()
                                                                        .setColor("Red")
                                                                        .setTitle(`${err}`)
                                                                        .setDescription("Could not find User in Database. Contact the Developer if this issue persists.")
                                                                        .setTimestamp()
                                                                ],
                                                                ephemeral: true
                                                            });
                        ...
                        case "create":
                            ...
                            collector.on("collect", async (i) => {
                                ...
                                return;
                                    ...
                                    return;
                                    case "dif":
                                        const dif = new ActionRowBuilder()
                                            .addComponents(
                                                new StringSelectMenuBuilder()
                                                    .setCustomId("difsel")
                                    ...
                                    case "finish":
                                        ...
                                        client.database.addSession(server, user, session)
                                            .then(async (msg1) => {
                                                client.database.writeLog(server, msg1)
                                                    .then(msg2 => client.database.writeDevLog(msg2))
                                                    .catch(err => client.database.writeDevLog(`${err}`))
                                            ...
                                            .catch(async (err) => {
                                                ...
                                                client.database.getServer(server)
                                                                    ...
                                                                    await mes.edit({
                                                                        embeds: [
                                                                            new EmbedBuilder()
                                                                                .setColor("Red")
                                                                                .setTitle(`${err}`)
                                                                                .setDescription("A Session with this Name already exists. Please choose a different Name!")
                                                                                .setTimestamp()
                                                                        ],
                                                                        ephemeral: true
                                                                    });
                                                    ...
                                                    .catch(async (err1) => {
                                                        client.database.writeLog(server, `${err1}`)
                                                            .then(async (msg1) => {
                                                                client.database.writeDevLog(msg1);
                        ...
                        return;
                        case "delete":
                            client.database.getUser(user.id, server)
                                .then(async (u) => {
                                    if (u.session_id) {
                                        ...
                                        client.database.getSession(server, user, { id: u.session_id })
                                            .then(async (s) => {
                                                s = s[0];
                                                if (!s.finished) {
                                                    ...
                                                    col4.on("collect", async (i) => {
                                                        ...
                                                        await i.deferUpdate();
                                                            client.database.remSession(server, user, s)
                                                                .then(async () => {
                                                                    await message.edit({
                                                                        content: "",
                                                                        embeds: [
                                                                            new EmbedBuilder()
                                                                                .setColor("Green")
                                                                                .setTitle("Success")
                                                                                .setDescription(`Session \"${s.name}\" has been deleted successfully!`)
                                                                                .setTimestamp()
                                                                        ],
                                                                        components: [],
                                                                        ephemeral: true
                                                    ...
                                                    if (!member.permissions.cache.has(PermissionFlagsBits.Administrator)) {
                                                        client.database.writeLog(server, "Error 401: Unauthorized")
                                                            .then(async (msg1) => {
                                                                client.database.writeDevLog(msg1);
                                                                await interaction.reply({
                                                                    embeds: [
                                                        ...
                                                        col4.on("collect", async (i) => {
                                                            if (i.customId === "confirm") {
                                                                await i.deferUpdate();
                                                                client.database.remSession(server, user, s[0])
                                                                    .then(async (msg1) => {
                                                                        client.database.writeLog(server, msg1)
                                                                            .then(msg2 => client.database.writeDevLog(msg2))
                                                                            .catch(err => client.database.writeDevLog(`${err}`));
                                                                        await message.edit({
                                                                            ...
                                                                            embeds: [
                                                                                new EmbedBuilder()
                                                                                    .setColor("Green")
                                                                                    .setTitle("Success")
                                                                                    .setDescription(`Session \"${s[0].name}\" has been deleted successfully!`)
                                                                                    .setTimestamp()
                                                                            ],
                                                                            components: [],
                                                                            ephemeral: true
                            ...
                            client.database.getUser(user.id, server)
                                .then(async (u) => {
                                    if (!u.session_id) {
                                        ...
                                        client.database.getServer(server.id)
                                            .then(async (serv) => {
                                                client.database.getSession(server, user, { id: u.session_id })
                                                    .then(async (s) => {
                                                        s = s[0];
                                                ...
                                                await interaction.reply({
                                                    embeds: [
                                                        new EmbedBuilder()
                                                            .setColor("Red")
                                                            .setTitle(`${err}`)
                                                            .setDescription("Could not find User in Database. Please contact the Develeoper if this Issue persists.")
                                                            .setTimestamp()
                                                    ],
                                                    ephemeral: true
                                                });
                                            ...
                                            .then(async (s) => {
                                                ...
                                                if (!s.started && s.finished) {
                                                    ...
                                                    if (!seschan) {
                                                        ...
                                                        while (!gamecol.ended) {
                                                            client.database.getSession(server, user, s)
                                                                .then(async (ses) => {
                                                                    if (ses.started) {
                                                                        await gamecol.stop();
                                                                        gamecol.ended = true;
                                                            ...
                                                            gamecol.on("collect", async (i) => {
                                                                if (i.customId == "join") {
                                                                    client.database.getUser(server, i.user)
                                                                        .then(async (u) => {
                                                                            if (!u.char_id) {
                                                                                const mes = await i.deferReply();
                                                                                await mes.edit({
                                                                                ...
                                                                                client.database.joinSession(server, u, { id: u.char_id }, user, s)
                                                                                .then(async function() {
                                                                                    client.database.getChar(u, { id: u.char_id })
                                                                                        .then(async (c) => {
                                                                                            const mes = await i.deferReply();
                                                                                            await mes.edit({
                                                                    ...
                                                                    client.database.getUser(server, i.user)
                                                                        .then(async (u) => {
                                                                            if (!u.char_id) {
                                                                                ...
                                                                                client.database.leaveSession(server, u, { id: u.char_id }, user, s)
                                                                                    .then(async function() {
                                                                                        client.database.getChar(u, { id: u.char_id })
                                                                                            .then(async () => {
                                                                                                const mes = await i.deferReply();
                                        ...
                                        client.database.getSession(server, user, { id: u.session_id })
                                            .then(async (s) => {
                                                ...
                                                if (!s.started && !s.finished) {
                                                    ...
                                                    if (!sesschan) {
                                                        client.database.writeLog(server, "Error 406: Invalid Channel")
                                                            .then(async (msg1) => {
                                                                client.database.writeDevLog(msg1);
                                                                await interaction.reply({
                                                                    embeds: [
                                                        ...
                                                        client.database.updateSession(server, user, s)
                                                            .then(msg1 => {
                                                                client.database.writeLog(server, msg1)
                                                                    .then(msg2 => client.database.writeDevLog(msg2))
                                                                    .catch(err => client.database.writeDevLog(`${err}`));
                                            ...
                                            .then(async (s) => {
                                                ...
                                                if (s.started && !s.finished) {
                                                    ...
                                                    if (!sesschann) {
                                                        ...
                                                        client.database.addGMXP(server, user, time)
                                                            .then(async () => {
                                                            ...
                                                            await interaction.reply({
                                                                embeds: [
                                                                    new EmbedBuilder()
                                                                        .setColor("Red")
                                                                        .setTitle("Error 401: Unauthorized")
                                                                        .setDescription("You may not use this Command on a Session that has not stated yet!")
                                                                        .setTimestamp()
                                                                ],
                                                                ephemeral: true
                                                            });
