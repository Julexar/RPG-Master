                            ...
                            switch (option.getSubcommandGroup()) {
                                case 'add':
                                    ...
                                    row1.addComponents(
                                        ...
                                        new ButtonBuilder().setCustomId('dex').setLabel('Set Dex-Bonus').setEmoji('🔢').setStyle(ButtonStyle.Primary)
                                    );
                                    row2.addComponents(
                                        new ButtonBuilder().setCustomId('ac').setLabel('Set AC').setEmoji('🛡️').setStyle(ButtonStyle.Primary),
                                        new ButtonBuilder().setCustomId('str').setLabel('Set Str-Requirement').setEmoji('💪').setStyle(ButtonStyle.Primary),
                                        new ButtonBuilder().setCustomId('magical').setLabel('Make magical').setEmoji('🪄').setStyle(ButtonStyle.Primary),
                                        new ButtonBuilder().setCustomId('attune').setLabel('Toggle Attunement').setEmoji('✴️').setStyle(ButtonStyle.Primary)
                                    );
                                        ...
                                        switch (i.customId) {
                                            ...
                                            case 'type':
                                                const tsel = new ActionRowBuilder().addComponents(
                                                    new StringSelectMenuBuilder().setCustomId('tsel').setMaxValues(1).setPlaceholder('No Type selected...').setOptions(
                                                        {
                                                            label: 'Light Armor',
                                                            value: 'Light',
                                                        },
                                            ...
                                            case 'rarity':
                                                const rsel = new ActionRowBuilder().addComponents(
                                                    new StringSelectMenuBuilder().setCustomId('rsel').setMaxValues(1).setPlaceholder('No Rarity selected...').setOptions(
                                                        {
                                                            label: 'Common',
                                                            value: 'Common',
                                                        },
                                            ...
                                            case 'attune':
                                                const asel = new ActionRowBuilder().addComponents(
                                                    new StringSelectMenuBuilder().setCustomId('asel').setMaxValues(1).setPlaceholder('No Option selected...').setOptions(
                                                        {
                                                            label: 'True',
                                                            value: 'true',
                                                        },
                                                ...
                                                col.on('collect', (j) => {
                                                    if (j.customId == 'asel') {
                                                        ...
                                                        row3.addComponents(new ButtonBuilder().setCustomId('attreq').setLabel('Set Attune Requirement').setStyle(ButtonStyle.Primary).setEmoji('📝'));
                                                        col.stop();
                                                    }
                                                });
                                                col.on('end', async (collected) => {
                                            ...
                                            case 'magical':
                                                const msel = new ActionRowBuilder().addComponents(
                                                    new StringSelectMenuBuilder().setCustomId('msel').setMaxValues(1).setPlaceholder('No Option selected...').setOptions(
                                                        {
                                                            label: 'True',
                                                            value: 'true',
                                                        },
                                                ...
                                                col.on('collect', (j) => {
                                                    if (j.customId == 'msel') {
                                                        ...
                                                        row3.addComponents(new ButtonBuilder().setCustomId('mb').setLabel('Set Magic Bonus').setStyle(ButtonStyle.Primary).setEmoji('✨'));
                                                        if (j.values[0] == 'true') {
                                                            menu.setFields(
                                                                {
                                                                    name: 'Name',
                                                        ...
                                                        client.database
                                                            ...
                                                            .then(async (msg1) => {
                                                                ...
                                                                if (String(err).includes('Error 409')) {
                                                                    await mes.edit({
                                                                        embeds: [new EmbedBuilder().setColor('Red').setTitle(`${err}`).setDescription('An Armor with that Name already exists in the Database!').setTimestamp()],
                                                                        ephemeral: true,
                                                                    });
                                                                } else {
                                                                    await mes.edit({
                                ...
                                case 'remove':
                                    const rows = [];
                                    const selrow = new ActionRowBuilder().addComponents(new StringSelectMenuBuilder().setCustomId('armsel').setMaxValues(1).setPlaceholder('No Armor selected...'));
                                    rows.push(selrow);
                                    let num = 0;
                                        ...
                                        .catch(async (err) => {
                                            client.database
                                                ...
                                                .then(async (msg1) => {
                                                    ...
                                                    if (String(err).includes('Error 404')) {
                                                        await interaction.reply({
                                                            embeds: [new EmbedBuilder().setColor('Red').setTitle(`${err}`).setDescription('Could not find any Armor in the Database. Make sure to add some Armor before you try again.').setTimestamp()],
                                                            ephemeral: true,
                                                        });
                                                    } else {
                                                        await interaction.reply({
