    ...
    async run(client, interaction) {
        ...
        switch (option.getSubcommand()) {
            ...
            case "remove":
                ...
                client.database.getPrefixes(server)
                    .then(async (list) => {
                        ...
                        collector.on("collect", async (i) => {
                            if (i.customId == "selpref") {
                                await i.deferUpdate();
                                client.database.remPrefix(server, i.values[0])
                                    .then(async (mes) => {
                                        client.database.writeLog(server, mes)
                                            ...
                                            await msg.edit({
                                                ...
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setColor("Green")
                                                        .setTitle("Success")
                                                        .setDescription(`Removed Prefix \`${i.values[0]}\``)
                                                        .setTimestamp()
                                                ],
                                                components: []
                                            });
                                                    ...
                                                    await mes.edit({
                                                        emebeds: [
                                                            new EmbedBuilder()
                                                                .setColor("Red")
                                                                .setTitle(`${err}`)
                                                                .setDescription("That Prefix does not exist within this Server!")
                                                                .setTimestamp()
                                                        ],
                                                        ephemeral: true
                                                    });
                                    ...
                                    await interaction.reply({
                                        embeds: [
                                            new EmbedBuilder()
                                                .setColor("Red")
                                                .setTitle(`${err}`)
                                                .setDescription("There are no registered Prefixes for this Server!")
                                                .setTimestamp()
                                        ],
                                        ephemeral: true
                                    });
