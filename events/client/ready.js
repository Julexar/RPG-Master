            ...
            client.database
                ...
                .then((c) => {
                    ...
                    if (c.enabled != cmd.enabled) {
                        ...
                        client.database
                            .updateCommand({ id: c.id, enabled: cmd.enabled }, c.type)
            ...
            .then((servers) => {
                servers.forEach(async (server) => {
                    ...
                    if (!client.guilds.cache.has(server.id)) {
                        ...
                        await client.database
                            ...
                            .then(async (msg) => {
                                await client.database
                                    ...
                                    .catch((err) => client.database.writeDevLog(`${err}`));
                                await client.database
                                    .writeLog(guild, 'Beginning Member registration - Searching Database for Members...')
                                    .then((msg1) => client.database.writeDevLog(msg1))
                                    .catch((err) => client.database.writeDevLog(`${err}`));
                                await client.database
                                    .getMember(guild)
                                    ...
                                    .catch(async (err) => {
                                        await client.database
                                            .writeLog(guild, `${err} in Database - attempting to add...`)
                                            .then((msg1) => client.database.writeDevLog(msg1))
                                            .catch((err1) => client.database.writeDevLog(`${err1}`));
                                        guild.members.cache.forEach(async (member) => {
                                            if (!member.user.bot) {
                                                await client.database
                                                    .getMember(guild, member.user)
                                                    .then(async () => {
                                                        await client.database
                                                            .writeLog(guild, 'Error 409: Duplicate Server Member')
                                                            .then((msg1) => client.database.writeDevLog(msg1))
                                                            .catch((err1) => client.database.writeDevLog(`${err1}`));
                                                    })
                                                    .catch(async (err1) => {
                            ...
                            .catch(async (err) => {
                                ...
                                if (String(err).includes('Error 409')) {
                                    ...
                                    await client.database
                                        ...
                                        .catch(async (err1) => {
                                            await client.database
                                                .writeLog(guild, `${err1} in Database - attempting to add...`)
                                                .then((msg) => client.database.writeDevLog(msg))
                                                .catch((err2) => client.database.writeDevLog(`${err2}`));
                                            guild.members.cache.forEach(async (member) => {
                                                if (!member.user.bot) {
                                    ...
                                    .then(async (server) => {
                                        if (server.print_logs) {
                                            if (server.log_chan) {
                                                ...
                                                await client.database
                                                    .writeLog(guild, 'Printing Logfile...')
                                                    .then((msg) => client.database.writeDevLog(msg))
                                                    .catch((err) => client.database.writeDevLog(err));
                                                await client.database
                                                    .getLog(guild)
                                                ...
                                                await client.database
                                                    .writeLog(guild, 'Error 404: No Log Channel defined')
                                                    .then((msg) => client.database.writeDevLog(msg))
                                                    .catch((err) => client.database.writeDevLog(`${err}`));
                                            }
                                        }
                        ...
                        await client.database
                            .writeLog(guild, 'Attempting to register Server Commands...')
                            .then((msg) => client.database.writeDevLog(msg))
                            .catch((err) => client.database.writeDevLog(`${err}`));
                                    ...
                                    await client.database
                                        ...
                                        .then(async (cmd) => {
                                            await client.database
                                                ...
                                                .then(async (msg) => {
                                                    await client.database
                                                        .writeLog(guild, `${msg} - Searching Database for restrictions...`)
                                                        .then((msg1) => client.database.writeDevLog(msg1))
                                                        .catch((err) => client.database.writeDevLog(`${err}`));
                                                    await client.database
                                                ...
                                                .catch(async (err) => {
                                                    if (String(err).includes('Error 409')) {
                                                        await client.database
                                                            .writeLog(guild, `${err} - Searching Database for restrictions...`)
                                                            .then((msg) => client.database.writeDevLog(msg))
                                                            .catch((err1) => client.database.writeDevLog(`${err1}`));
                                                        await client.database
                                                            .getRestriction(command)
                                                ...
                                                .catch(async (err1) => {
                                                    ...
                                                    if (String(err1).includes('Error 409')) {
                                                        ...
                                                        await client.database
                                                            ...
                                                            .catch(async (err2) => {
                                                                await client.database
                                                                    .writeLog(guild, `${err2} in Database - attempting to add...`)
                                                                    .then((msg1) => client.database.writeDevLog(msg1))
                                                                    .catch((err3) => client.database.writeDevLog(`${err3}`));
                                                                guild.members.cache.forEach(async (member) => {
                                                                    if (!member.user.bot) {
                                                        ...
                                                        await client.database
                                                            ...
                                                            .then(async (cmd) => {
                                                                await client.database
                                                                    ...
                                                                    .then(async (msg1) => {
                                                                        await client.database
                                                                            .writeLog(guild, `${msg1} - Searching Database for restrictions...`)
                                                                            .then((msg2) => client.database.writeDevLog(msg2))
                                                                            .catch((err1) => client.database.writeDevLog(`${err1}`));
                                                                        await client.database
                                                                            .getRestriction(command)
