...
class ServerSubclass {
    ...
    static async remove(server, sub) {
        ...
        if (await this.isDeleted(server, sub))
            throw new BadRequestError('Server Subclass deleted', 'The Subclass you are trying to delete has already been deleted!');
    ...
    static async update(server, sub) {
        ...
        if (await this.isDeleted(server, sub))
            throw new BadRequestError('Server Subclass deleted', 'The Subclass you are trying to update has been deleted!');
