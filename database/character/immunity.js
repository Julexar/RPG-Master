...
class CharacterImmunity {
    ...
    static async getOne(server, char, immune) {
        if (immune.id) {
            ...
            if (charImmune.deleted_at)
                throw new BadRequestError('Character Immunity deleted', 'The Character Immunity you are trying to view has been deleted!');
    ...
    static async remove(server, char, immune) {
        ...
        if (await this.isDeleted(server, char, immune))
            throw new BadRequestError('Character Immunity deleted', 'The Character Immunity you are trying to remove has already been deleted!');
