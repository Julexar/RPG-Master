...
class CharacterRaceProficiency {
    ...
    static async getOne(char, race, prof) {
        if (prof.id) {
            ...
            if (charRaceProf.deleted_at)
                throw new BadRequestError(
                    'Character Race Proficiency deleted',
                    'The racial Proficiency of that Character that you are trying to view has been deleted!'
                );
    ...
    static async remove(char, race, prof) {
        ...
        if (await this.isDeleted(char, race, prof))
            throw new BadRequestError(
                'Character Race Proficiency deleted',
                'The racial Proficiency of that Character that you are trying to delete has already been deleted!'
            );
    ...
    static async update(char, race, prof) {
        ...
        if (await this.isDeleted(char, race, prof))
            throw new BadRequestError(
                'Character Race Proficiency deleted',
                'The racial Proficiency of that Character that you are trying to update has been deleted!'
            );
    ...
    static async restore(char, race, prof) {
        ...
        if (!(await this.isDeleted(char, race, prof)))
            throw new BadRequestError(
                'Character Race Proficiency not deleted',
                'The racial Proficiency of that Character that you are trying to restore has not been deleted!'
            );
