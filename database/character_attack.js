...
class CharacterAttack {
    ...
    static async update(char, atk) {
        ...
        const sql = "UPDATE character_attacks SET name = $1, description = $2, atk_stat = $3, save = $4, save_stat = $5, on_fail = $6, dmg_dice = $7, dmg_dice_size = $8, dmg = $9, dmg_type_id = $10, magical = $11, magic_bonus = $12 WHERE char_id = $13 AND id = $14";
