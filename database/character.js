...
class character {
    ...
    async update(user, char) {
        ...
        const sql = "UPDATE characters SET name = $1, ac = $2, hp = $3, hp_max = $4, hp_temp = $5, init = $6, level = $7, xp = $8, pp = $9, gp = $10, ep = $11, sp = $12, cp = $13, armor_id = $14, race_id = $15, subrace_id = $16 class_id = $17, subclass_id = $18, class_level = $19, multi = $20, mc1_id = $21, mc1_sub_id = $22, mc1_level = $23, mc2_id = $24, mc2_sub_id = $25, mc2_level = $26, mc3_id = $27, mc3_sub_id = $28, mc3_level = $29, portrait = $30, hp_method = $31 WHERE user_id = $32 AND id = $33";
        await query(sql, [char.name, char.ac, char.hp.current, charHP, charHPMax, charHPTemp, char.init, char.level, char.xp, pp, gp, ep, sp, cp, char.multi, charRace, charSubRace, charClass, charSubClass, char.class_level, charMC1, charMC1Sub, charMC1Lvl, charMC2, charMC2Sub, charMC2Lvl, charMC3, charMC3Sub, charMC3Lvl, char.portrait, charHPMethod, user.id, char.id])
